...
from models.fusion_vit_2branch import VisionTransformer, PyramidVisionTransformer
...
class BaseLine(nn.Module):
    ...
    def forward(self, x, x_lbp_hog):
        ...
        x_lbp_feature, x_lbp2, xlbp3 = self.face_landback(x_lbp_hog)
        # x_lbp_feature = self.conv3_lh(x_lbp_feature)
        x_lbp_feature = x_lbp_feature.view(B_, -1, 49).transpose(1, 2)
        x_lm = x_landmark+x_lbp_feature
        y_hat = self.ViT(x_cnn_feature, x_lm)
