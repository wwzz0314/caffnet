...
class Affect7DataSet(data.Dataset):
    def __init__(self, path, train=True, transform=None, basic_aug=False):
        self.train = train
        self.root = path
        self.transform = transform
        self.train_paths = os.path.join(self.root, 'train_set/annotations_7cls.txt')
        self.val_paths = os.path.join(self.root, 'val_set/annotations_7cls.txt')
